    ...
    <Grid container className={classes.root}>
      <Grid item xs={12} className={classes.headerRow}>
        <Paper className={classes.paper} square elevation={2}>
          <Typography color="#c17900" variant="h6">
            {props.scope}
          </Typography>
        </Paper>
      </Grid>
                ...
                {messages.map((m) => (
                  ...
                  >
                    ...
                    <ListItemText
                      ...
                      primary={<Typography style={{color:"#c17900"}} variant='h6'>{m.fromObj[0] && m.fromObj[0].name}</Typography>}
                      secondary={<Typography style={{color:"maroon"}}>{m.body}</Typography>}
